...
export class Match extends Component {
	...
	render(props) {
		let url = this.nextUrl || getCurrentUrl() || (props.history && props.history.location && props.history.location.pathname) || (props.history && props.history.getCurrentLocation && props.history.getCurrentLocation() && props.history.getCurrentLocation().pathname) || '',
			path = url.replace(/\?.+$/,'');
		this.nextUrl = null;
